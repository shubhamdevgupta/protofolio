  ...
  const projects = [
    {
      title: "Nal Jal Sewa",
      description:
        "Led a team of 8 developers in creating a national-level hybrid mobile application for state-wise water supply billing and dashboarding across Karnataka, Madhya Pradesh, and Assam. Features village-level consumer registration, bill generation, and revenue tracking with real-time data visualization.",
